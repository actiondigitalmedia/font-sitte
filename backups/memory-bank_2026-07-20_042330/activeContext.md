...
## Blocked on user (30 seconds)
1. Repo **Settings → Pages → Source: GitHub Actions**
2. After deploy: GSC URL-prefix property + submit `sitemap.xml`
3. Drop `google*.html` verification file into `free-font-site/web/` if using HTML-file verify
