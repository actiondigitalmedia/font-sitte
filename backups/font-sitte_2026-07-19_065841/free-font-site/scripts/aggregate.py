...
def run(fetch: bool = True, libre_only: bool = True) -> dict:
    ...
    if fetch:
        ...
        print("Fetching Fontsource (non-Google)...")
    ...
    source_entries = [
        ...
        ("fontsource", fontsource.to_catalog_entries(fontsource_raw), fontsource_raw),
        ("omnibus-type", omnibus_type.to_catalog_entries(omnibus_raw), omnibus_raw),
